  ...
  return (
    <div className="col-span-1 lg:col-span-2">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-stone-50 dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700 rounded-sm px-5 py-4">
        ...
        <Link
          href="/upgrade"
          className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-sm bg-stone-900 dark:bg-stone-100 text-stone-50 dark:text-stone-900 text-[12px] font-medium hover:opacity-80 transition-opacity"
        >
          Subscribe — £4/mo →
        </Link>
      </div>
