      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-[14px] text-stone-500 dark:text-stone-400 leading-relaxed mb-8 max-w-sm mx-auto">
            10 questions. 2 minutes. Find out whether you are a Magic Circle, US firm, Silver Circle, international, or boutique fit — and get 3 personalised firm recommendations.
          </p>
    ...
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Question counter */}
          <p className="font-mono text-[10px] tracking-widest uppercase text-stone-400 dark:text-stone-500 mb-4 text-center">
              ...
              return (
                ...
                >
                  <span className="flex items-start gap-3">
                    <span className={`flex-shrink-0 w-5 h-5 rounded-full border flex items-center justify-center mt-0.5 ${
                      isSelected
                        ? 'border-stone-50 dark:border-stone-900'
                        : 'border-stone-300 dark:border-stone-600'
                    }`}>
                      {isSelected && (
                        <span className="w-2.5 h-2.5 rounded-full bg-stone-50 dark:bg-stone-900" />
                      )}
                    </span>
                    {option.label}
                  </span>
    ...
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col">
      ...
      <main className="flex-1 max-w-lg mx-auto px-4 sm:px-6 py-10 w-full">
              ...
              return (
                <div key={tier.key}>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`font-mono text-[10px] ${tc.accent}`}>
                      {score}
                    </span>
                  </div>
                  <div className="h-2 rounded-full bg-stone-100 dark:bg-stone-800 overflow-hidden">
                    <div
                      className={`h-full rounded-full ${tc.dot} transition-all duration-500`}
                      style={{ width: `${pct}%` }}
                    />
                  </div>
                </div>
        ...
        <div className="mt-8 rounded-xl bg-stone-900 dark:bg-stone-100 px-5 py-5 text-center">
          <p className="text-[14px] font-medium text-stone-50 dark:text-stone-900 mb-2">
