...
const CSP = [
  ...
  `script-src 'self' 'unsafe-inline'${isProd ? '' : " 'unsafe-eval'"} https://js.stripe.com https://checkout.stripe.com https://clerk.com https://*.clerk.com https://*.clerk.accounts.dev https://clerk.folioapp.co.uk https://challenges.cloudflare.com`,
  ...
  "connect-src 'self' https://*.clerk.com https://clerk.com wss://*.clerk.com https://clerk.accounts.dev https://*.clerk.accounts.dev https://clerk.folioapp.co.uk https://*.clerk.folioapp.co.uk wss://clerk.folioapp.co.uk https://api.stripe.com https://checkout.stripe.com https://errors.stripe.com https://*.public.blob.vercel-storage.com",
